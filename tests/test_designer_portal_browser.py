...
def test_designer_portal_real_chrome_a_to_g(client, live_server):
    ...
    try:
        ...
        _replace(zone_form.find_element(By.NAME, "x"), "0.50")
        _replace(zone_form.find_element(By.NAME, "y"), "0.38")
        _replace(zone_form.find_element(By.NAME, "max_width_mm"), "210")
        _replace(zone_form.find_element(By.NAME, "max_height_mm"), "250")
        ...
        driver.find_element(By.NAME, "title").send_keys("North Wave Tee")
        ...
        _replace(placement_form.find_element(By.NAME, "x"), "0.50")
        _replace(placement_form.find_element(By.NAME, "y"), "0.50")
        _replace(placement_form.find_element(By.NAME, "scale"), "0.30")
        _replace(placement_form.find_element(By.NAME, "rotation"), "12")
        ...
        _replace(driver.find_element(By.NAME, "quantity"), "100")
        ...
        _replace(driver.find_element(By.NAME, "base_price"), "650")
