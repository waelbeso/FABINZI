...
REST_FRAMEWORK={"DEFAULT_AUTHENTICATION_CLASSES":["rest_framework.authentication.SessionAuthentication"],"DEFAULT_PERMISSION_CLASSES":["rest_framework.permissions.IsAuthenticated"],"DEFAULT_VERSIONING_CLASS":"rest_framework.versioning.NamespaceVersioning","DEFAULT_THROTTLE_CLASSES":["rest_framework.throttling.AnonRateThrottle","rest_framework.throttling.UserRateThrottle"],"DEFAULT_THROTTLE_RATES":{"anon":env("API_ANON_RATE",default="120/hour"),"user":env("API_USER_RATE",default="1200/hour")}}
CACHES={"default":{"BACKEND":"django.core.cache.backends.locmem.LocMemCache","LOCATION":"fabinzi-runtime-throttles"}}
REDIS_URL=env("REDIS_URL",default="redis://localhost:6379/0"); CELERY_BROKER_URL=REDIS_URL; CELERY_RESULT_BACKEND=REDIS_URL; CELERY_TASK_ACKS_LATE=True; CELERY_TASK_REJECT_ON_WORKER_LOST=True; CELERY_TASK_TIME_LIMIT=300; CELERY_TASK_SOFT_TIME_LIMIT=270; CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP=True; CELERY_BEAT_SCHEDULE={"dispatch-pending-notifications":{"task":"apps.notifications.tasks.dispatch_pending_deliveries","schedule":60.0}}
INTEGRATION_ENCRYPTION_KEY=env("INTEGRATION_ENCRYPTION_KEY",default="")
if DEBUG and not INTEGRATION_ENCRYPTION_KEY: INTEGRATION_ENCRYPTION_KEY="DEBUG"
...
SECURE_CONTENT_TYPE_NOSNIFF=True; SECURE_CROSS_ORIGIN_OPENER_POLICY="same-origin"; CSRF_COOKIE_SAMESITE="Lax"; SESSION_COOKIE_SAMESITE="Lax"
