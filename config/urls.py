...
from apps.checkout.views import checkout_detail, checkout_start, order_detail, orders
...
urlpatterns = [
    ...
    path("studio/",studio,name="studio"),path("studio/<int:pk>/",studio_project,name="studio-project"),path("studio/<int:project_id>/checkout/",checkout_start,name="checkout-start"),path("checkout/<int:pk>/",checkout_detail,name="checkout-detail"),path("orders/",orders,name="orders"),path("orders/<int:pk>/",order_detail,name="order-detail"),path("artwork/",artwork_marketplace,name="artwork"),
