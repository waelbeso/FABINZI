...
urlpatterns = [
    path("",home,name="home"),path("app/",app_home,name="app-home"),path("app/settings/preferences/",profile_preferences,name="profile-preferences"),path("studio/",placeholder_surface,{"surface":"Studio"},name="studio"),path("artwork/",artwork_marketplace,name="artwork"),
