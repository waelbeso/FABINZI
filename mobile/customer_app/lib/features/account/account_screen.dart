  ...
  Widget build(BuildContext context) => ListView(
    ...
    children: [
      if (controller.profile != null)
        Card(
          child: ListTile(
            ...
            subtitle: Text(
              controller.profile!.email.isNotEmpty
      ...
      ListTile(
        ...
        title: Text(L10n.t(context, 'accountCapabilities')),
        subtitle: Text(L10n.t(context, 'unsupportedAccountActions')),
      ),
      if (controller.profile != null) ...[
        ...
        OutlinedButton.icon(
          ...
          label: Text(L10n.t(context, 'signOut')),
        ),
      ],
