...
class SessionAwareTokenStore implements TokenStore {
  ...
  @override
  Future<String?> readAccess() => delegate.readAccess();
  @override
  Future<String?> readRefresh() => delegate.readRefresh();
  @override
  Future<void> write(SessionTokens tokens) => delegate.write(tokens);
  @override
  Future<void> clear() async {
