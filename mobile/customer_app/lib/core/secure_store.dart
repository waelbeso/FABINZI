...
class SecureTokenStore implements TokenStore {
  ...
  @override Future<String?> readAccess() => _storage.read(key: _accessKey);
  @override Future<String?> readRefresh() => _storage.read(key: _refreshKey);
...
class SessionAwareTokenStore implements TokenStore {
  SessionAwareTokenStore(this.delegate);
  final TokenStore delegate;
  void Function()? onCleared;
  @override Future<String?> readAccess() => delegate.readAccess();
  @override Future<String?> readRefresh() => delegate.readRefresh();
  @override Future<void> write(SessionTokens tokens) => delegate.write(tokens);
  @override Future<void> clear() async {
