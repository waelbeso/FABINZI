...
void main() {
  testWidgets(
    'login screen exposes supported login only and no fabricated reset/signup actions',
    (tester) async {
  ...
  testWidgets('touch controls satisfy a minimum 48 logical pixel tap target', (
    tester,
  ) async {
