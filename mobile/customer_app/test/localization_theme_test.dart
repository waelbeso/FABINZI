...
void main() {
  test('Arabic and English string catalogs have exact key parity', () => expect(L10n.hasParity, isTrue));
  ...
  testWidgets('English resolves LTR', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      home: Builder(builder: (context) { direction = Directionality.of(context); return Text(L10n.t(context, 'discover')); }),
    ));
