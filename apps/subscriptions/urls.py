...
urlpatterns = [
    ...
    path(
        ...
        designer_context_guard(designer_subscription),
        name="designer-subscription",
    ),
    path(
        "manufacturer/subscription/",
        manufacturer_context_guard(manufacturer_subscription),
        name="manufacturer-subscription",
    ),
    path(
        "team/invitations/accept/<str:token>/",
